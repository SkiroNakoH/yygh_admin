    ...
    <div class="app-container">
        ...
        <el-table v-loading="listLoading" :data="list" border fit highlight-current-row>
            ...
            <el-table-column label="操作" width="230" align="center">
                <template slot-scope="scope">
                    <router-link :to="'/yygh/hospital/show/' + scope.row.id">
                        <el-button type="primary" size="mini">查看</el-button>
                    </router-link>
                    <router-link :to="'/yygh/hospital/schedule/' + scope.row.hoscode">
...
export default {
    ...
    methods: {
        ...
        fetchData(page = 1) {
            this.page = page
            hospital.findPage(this.page, this.limit, this.searchObj)
                .then(response => {
                    //每页数据集合
        ...
        //查询所有省
        findAllProvince() {
            dict.findDictByParentCode('Province')
                .then(response => {
        ...
        provinceChanged() {
            ...
            //调用方法，根据省id，查询下面子节点
            dict.findListByParentId(this.searchObj.provinceCode)
                .then(response => {
