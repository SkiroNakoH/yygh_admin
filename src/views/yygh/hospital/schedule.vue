...
export default {
    ...
    methods:{
        //查询排班详情
        getDetailSchedule() {
            schedule.findScheduleDetail(this.hoscode,this.depcode,this.workDate)
                .then(response => {
        ...
        fetchData() {
            department.findDepartmentTree(this.hoscode)
                .then(response => {
        ...
        getScheduleRule() {
            schedule.arrangeDate(this.page, this.limit, this.hoscode, this.depcode).then(response => {
